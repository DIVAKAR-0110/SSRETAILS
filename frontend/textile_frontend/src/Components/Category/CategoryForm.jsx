...
export default function CategoryForm({ open, onClose, onSaved, initialData }) {
  ...
  const save = async () => {
    ...
    try {
      setSaving(true);
      await axios.post(`${API_BASE}/category/`, form);
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="drawer panel animate">
            <div className="drawer-header">
              <h3>{form.Code ? "Edit Category" : "Add Category"}</h3>
