...
import ReportTaxTypeView from "./ReportTaxTypeView";
...
export default function TaxType() {
  ...
  const loadAll = async () => {
    const res = await axios.get(`${API_BASE}/taxtype/`);
    setAll(res.data);
  };
  ...
  const onDelete = async () => {
    ...
    await axios.delete(`${API_BASE}/taxtype/delete/${selected.Code}/`);
  ...
  return (
    <>
      ...
      <div className="grade-page">
        ...
        <h2 style={{ fontFamily: "sans-serif" }}>Tax Type Master</h2>
        <Tools
          onAdd={onAdd}
          onEdit={onEdit}
          onDelete={onDelete}
