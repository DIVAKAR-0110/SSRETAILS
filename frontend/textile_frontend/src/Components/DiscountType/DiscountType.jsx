...
import DiscountTypeForm from "./DiscountTypeFom";
import ReportDiscountTypeView from "./ReportDiscountTypeView";
...
export default function DiscountType() {
  ...
  const loadAll = async () => {
    const res = await axios.get(`${API_BASE}/discounttype/`);
    setAll(res.data);
  };
  ...
  const onDelete = async () => {
    ...
    await axios.delete(`${API_BASE}/discounttype/delete/${selected.Code}/`);
  ...
  return (
    <>
      ...
      <div className="grade-page">
        ...
        <h2 style={{ fontFamily: "cursive" }}>Discount Type Master</h2>
        <Tools
          onAdd={onAdd}
          onEdit={onEdit}
          onDelete={onDelete}
