 ...
 * ReportView
 * props:
 *  - open (bool) - handled by parent, but we show/hide using parent
 *  - onClose()
 *  - data: array of country objects
 *  - theme: "blue" | "gray" | "metal"
 */
export default function ReportView({ data = [], onClose, theme = "metal" }) {
