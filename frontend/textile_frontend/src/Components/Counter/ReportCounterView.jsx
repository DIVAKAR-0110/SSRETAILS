...
export default function ReportCounterView({
  data = [],
  onClose,
  theme = "metal",
}) {
              ...
              {filtered.map((r) => (
                <div className="grid-card" key={r.Code}>
                  ...
                  <div className="grid-body">
                    ...
                    <div>Group: {r.CounterGroupCode}</div>
                    <div>Section: {r.SectionCode}</div>
                    <div>Order: {r.CounterOrder}</div>
