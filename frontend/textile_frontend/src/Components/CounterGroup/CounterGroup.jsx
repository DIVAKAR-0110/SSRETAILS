...
import CounterGroupForm from "./CounterGroupForm";
import ReportCounterGroupView from "./ReportCounterGroupView";
...
export default function CounterGroup() {
  ...
  const loadAll = async () => {
    const res = await axios.get(`${API_BASE}/countergroup/`);
    setAll(res.data);
  };
  ...
  const onDelete = async () => {
    ...
    await axios.delete(`${API_BASE}/countergroup/delete/${selected.Code}/`);
  ...
  return (
    <>
      ...
      <div className="grade-page">
        ...
        <h2 style={{ fontFamily: "sans-serif" }}>Counter Group Master</h2>
        <Tools
          onAdd={onAdd}
          onEdit={onEdit}
          onDelete={onDelete}
