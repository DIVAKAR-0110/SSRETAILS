...
import ReportPaymentModeView from "./ReportPaymentModeView";
...
export default function PaymentMode() {
  ...
  const loadAll = async () => {
    const res = await axios.get(`${API_BASE}/paymentmode/`);
    setAll(res.data);
  };
  ...
  const onDelete = async () => {
    ...
    await axios.delete(`${API_BASE}/paymentmode/delete/${selected.Code}/`);
  ...
  return (
    <>
      ...
      <div className="grade-page">
        ...
        <h2 style={{ fontFamily: "fantasy" }}>Payment Mode Master</h2>
        <Tools
          onAdd={onAdd}
          onEdit={onEdit}
          onDelete={onDelete}
