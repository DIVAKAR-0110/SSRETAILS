...
import TransferModeForm from "./TransferModeForm";
import ReportTransferModeView from "./ReportTransferModeView";
...
export default function TransferMode() {
  ...
  const loadAll = async () => {
    const res = await axios.get(`${API_BASE}/transfermode/`);
    setAll(res.data);
  };
  ...
  const onDelete = async () => {
    ...
    await axios.delete(`${API_BASE}/transfermode/delete/${selected.Code}/`);
  ...
  return (
    <>
      ...
      <div className="grade-page">
        ...
        <h2 style={{ fontFamily: "cursive" }}>Transfer Mode Master</h2>
        <Tools
          onAdd={onAdd}
          onEdit={onEdit}
          onDelete={onDelete}
