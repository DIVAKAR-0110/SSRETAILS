...
export default function ReportTransferModeView({
  data = [],
  onClose,
  theme = "metal",
}) {
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = "transfermode_report.csv";
    a.click();
              ...
              {filtered.map((r) => (
                <div className="grid-card" key={r.Code}>
                  ...
                  <div className="grid-body">
                    ...
                    <div>Num Gen: {r.NumGeneration ? "Yes" : "No"}</div>
