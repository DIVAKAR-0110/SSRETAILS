...
export default function ReligionForm({ open, onClose, onSaved, initialData }) {
  ...
  const save = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${API_BASE}/religion/add/`, payload);
      ...
      <Dialog.Root open={open} onOpenChange={onClose}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="drawer panel animate">
            <Dialog.Title>
              {form.Code ? "Edit Religion" : "Add Religion"}
